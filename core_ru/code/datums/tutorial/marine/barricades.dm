/datum/tutorial/marine/barricade
	name = "Marine - Barricade"
	desc = "A tutorial to get you acquainted with the very basics of how barricades work."
	tutorial_id = "marine_cades_1"
...
/datum/tutorial/marine/barricade/start_tutorial(mob/starting_mob)
	. = ..()
	if(!.)
		return
	...
	init_mob()
	message_to_player("This is the tutorial for marine construction. Leave the cryopod by pressing <b>[retrieve_bind("North")]</b> or <b>[retrieve_bind("East")]</b> to continue.")
...
/datum/tutorial/marine/barricade/proc/on_cryopod_exit()
	SIGNAL_HANDLER
...
/datum/tutorial/marine/barricade/proc/on_food_vend(datum/source, obj/structure/machinery/cm_vending/vendor, list/itemspec, mob/living/carbon/human/user)
	SIGNAL_HANDLER
...
/datum/tutorial/marine/barricade/proc/on_foodbar_eaten(datum/source, obj/item/reagent_container/food/snacks/eaten_food)
	SIGNAL_HANDLER
...
/datum/tutorial/marine/barricade/proc/on_clothing_vend(datum/source)
	SIGNAL_HANDLER
...
/datum/tutorial/marine/barricade/proc/on_flare_light(datum/source, obj/item/used)
	SIGNAL_HANDLER
...
/datum/tutorial/marine/barricade/proc/on_flare_throw(datum/source, obj/item/thrown)
	SIGNAL_HANDLER
...
/datum/tutorial/marine/barricade/proc/on_gun_vend(datum/source)
	SIGNAL_HANDLER
...
/datum/tutorial/marine/barricade/proc/on_magazine_insert(datum/source, atom/attacked, obj/item/attacked_with)
	SIGNAL_HANDLER
...
/datum/tutorial/marine/barricade/proc/on_gun_wield(datum/source, obj/item/used)
	SIGNAL_HANDLER
...
/datum/tutorial/marine/barricade/proc/on_magazine_empty(obj/item/weapon/gun/empty_gun)
	SIGNAL_HANDLER
...
/datum/tutorial/marine/barricade/proc/on_xeno_death(datum/source)
	SIGNAL_HANDLER
...
/datum/tutorial/marine/barricade/proc/dim_room()
	TUTORIAL_ATOM_FROM_TRACKING(/obj/item/device/flashlight, flashlight)
	flashlight.set_light_on(FALSE)

/datum/tutorial/marine/barricade/proc/brighten_room()
	TUTORIAL_ATOM_FROM_TRACKING(/obj/item/device/flashlight, flashlight)
	flashlight.set_light_on(TRUE)

/datum/tutorial/marine/barricade/proc/disappear_xeno()
	TUTORIAL_ATOM_FROM_TRACKING(/mob/living/carbon/xenomorph/drone/tutorial, xeno_dummy)
...
/datum/tutorial/marine/barricade/init_mob()
	. = ..()
...
/datum/tutorial/marine/barricade/init_map()
